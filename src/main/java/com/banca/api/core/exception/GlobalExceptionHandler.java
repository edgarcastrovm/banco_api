package com.banca.api.core.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNoSuchElementFoundException(NoSuchElementFoundException itemNotFoundException, WebRequest request) {
        ...
        return buildErrorResponse(itemNotFoundException,"BAD REQUEST", HttpStatus.NOT_FOUND, request);
    }
    ...
    private ResponseEntity<Object> buildErrorResponse(Exception exception, HttpStatus httpStatus, WebRequest request) {
        return buildErrorResponse(exception, "Bad request", httpStatus, request);
    }
